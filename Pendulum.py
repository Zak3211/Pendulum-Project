...
def update(th1, th2, w1, w2, o1, o2):
    ...
    th1, th2, w1, w2, o1, o2 = new_th1, new_th2, new_w1, new_w2, new_o1, new_o2

    #using simplectic method instead for updating variables

    """ o1 = (fun3(th1, th2, w2))
    o2 = (fun4(th1, th2, w1, w2))
